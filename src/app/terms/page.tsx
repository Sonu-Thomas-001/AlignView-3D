        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-12 border border-slate-200/90 shadow-sm space-y-10 text-xs sm:text-sm text-slate-700 leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <p>
                AlignView 3D, including its source code, 3D dental mathematical algorithms, geometry generation engines, shader pipelines, user interfaces, branding, and visual assets (collectively, the &quot;Software&quot;), is the exclusive proprietary intellectual property of <strong>MidCell Studios</strong> (&quot;Owner&quot;). All rights, title, and interest are strictly reserved.
              </p>
            </section>
