...
// Custom Tooth Icons matching the design
...
export const ViewModePill: React.FC = () => {
  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20 select-none">
      <div className="bg-white/95 backdrop-blur-md rounded-full shadow-floating border border-slate-200/80 p-1 flex items-center gap-1">
        {MODES.map((mode) => {
