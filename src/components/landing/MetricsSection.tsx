...
import { Zap, Layers, Cpu, Ruler, Activity } from 'lucide-react';
...
const METRICS = [
  ...
  },
  {
    ...
    description: 'Dynamic parametric torque, tipping, and expansion morphing sequence across unlimited stages.',
    badge: 'Continuous Multi-Stage Morphing',
...
export const MetricsSection: React.FC = () => {
  return (
    <section id="metrics" className="py-8 sm:py-12 bg-[#F4F6FA] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Unified High-Performance Studio Showcase Card */}
        <ScrollReveal animation="scale-up" duration={700}>
          <div className="relative rounded-3xl bg-slate-950 border border-slate-800 shadow-2xl p-6 sm:p-10 lg:p-12 overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10 pb-6 border-b border-slate-800/80 relative z-10">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-extrabold uppercase tracking-wider mb-2">
            ...
            {/* 4 Performance Metric Columns with staggered entrance */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
              {METRICS.map((item, idx) => (
                <ScrollReveal 
                  ...
                  duration={500}
                >
                  <div className="relative h-full rounded-2xl p-5 sm:p-6 bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all flex flex-col justify-between group hover:bg-slate-900/90">
                    <div>
                      {/* Icon & Live Badge */}
